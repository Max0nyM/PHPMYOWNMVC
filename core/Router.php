...
class Router {
  ...
  $_url = $url;      
  //controller
  $controller = (isset($url[0]) && $url[0] != '' && file_exists(ROOT. DS . 'app'.DS.'controllers'.DS.$url[0].'.php')) ? ucwords($url[0]) : DEFAULT_CONTROLLER;
...
//params
if($controller_name == DEFAULT_CONTROLLER && $action_name== 'index')
$queryParams= $_url;
else
$queryParams = $url;
